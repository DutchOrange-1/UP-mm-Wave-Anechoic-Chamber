# Adapted from:
# https://github.com/Standa-Optomechanics/libximc/blob/dev-3.0/examples/test_Python/standardtest/testpython.py
...
try:
    ...
    print("Use libximc {} that has been found among the pip installed packages".format(
        ximc.ximc_version()))
except ImportError:
